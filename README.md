...
```
Que faire ?
**Réponse :** Il est probable qu'il manque un dossier. Il suffit juste de créer les dossiers `${CONTENT_PATH}/transmission/complete/radarr` et `${CONTENT_PATH}/transmission/complete/tv-sonarr` puisde redémarrer vos conteneurs.
